...
window.addEventListener('load', async () => {
    ...
    if (btnDescargar) {
        btnDescargar.addEventListener('click', (e) => {
            ...
            let quest33 = document.querySelector('input[name="quest31"]:checked').value;
            let quest34 = document.querySelector('input[name="quest32"]:checked').value;
            let quest35 = document.querySelector('input[name="quest33"]:checked').value;
...
async function generatePDF(promo,direccion,vivienda, tipoVivienda,
    ...
    if (signaturePad) {
        ...
        const img1 = await loadImage("/img/canvaIng/1.jpg");
        const img2 = await loadImage("/img/canvaIng/2.jpg");
        const img3 = await loadImage("/img/canvaIng/3.jpg");
        const img4 = await loadImage("/img/canvaIng/4.jpg");
        const img5 = await loadImage("/img/canvaIng/5.jpg");
        const img6 = await loadImage("/img/canvaIng/6.jpg");
        const img7 = await loadImage("/img/canvaIng/7.jpg");
        const img8 = await loadImage("/img/canvaIng/8.jpg");
